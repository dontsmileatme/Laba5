...
public class CreationOfHuman {
    ...
    public void setCoordinateXForCoordinates(HumanBeing.Coordinates coordinates) {
        try {
            ...
            if (!(x.equals("") || x.equals(null)) && Double.parseDouble(x) > -928)
    ...
    public void setCoordinateYForCoordinates(HumanBeing.Coordinates coordinates) {
        try {
            ...
            if (!(y.equals("") || y.equals(null)) && Long.parseLong(y) > -556) coordinates.setY(Long.parseLong(y));
            else {
