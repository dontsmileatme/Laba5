 ...
 */
public class Help implements CommandableWithoutArgument {

    public Help() {
        Commands.regist("help", this);
    }
    ...
    public void execute() {
        ...
        System.out.println("count_by_impact_speed impactSpeed: вывести количество элементов, значение поля impactSpeed которых меньше заданного");
        ...
        System.out.println("print_field_descending_minutes_of_waiting minutesOfWaiting : вывести значения поля minutesOfWaiting в порядке убывания");
    }
}
